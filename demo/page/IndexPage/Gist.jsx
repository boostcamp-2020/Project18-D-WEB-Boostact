...
const Gist = () => {
  return (
    <div id="Gist" style={{ width: "100%", height: "300px", display: "flex", marginTop: "100px", marginBottom: "100px", overflow: "hidden" }}>
      <div className="GistContents" style={{ maxWidth: `calc(33% - 26.7px)` }}>
        ...
        <div className="contents">
          ...
          <p style={{ fontSize: "20px" }}> 이 tag들을 통해서 Boostact는 Element를 새로 그릴지, 업데이트를 할지, 혹은 삭제를 할지 결정합니다.</p>
        </div>
      </div>
      <div className="GistContents" style={{ maxWidth: `calc(33% - 26.7px)`, marginLeft: "40px", marginRight: "40px" }}>
        ...
        <div className="contents">
          ...
          <p style={{ fontSize: "20px" }}>또한 하나의 컴포넌트 안에 여러 개의 훅들을 동시에 사용할 수도 있습니다.</p>
        </div>
      </div>
      <div className="GistContents" style={{ maxWidth: `calc(33% - 26.7px)` }}>
        <div className="title">
        ...
        <div className="contents">
          <p style={{ fontSize: "20px" }}>우리는 이 프레임워크를 순수한 JavaScript만 사용하여 만들었습니다.</p>
          <p style={{ fontSize: "20px" }}>
